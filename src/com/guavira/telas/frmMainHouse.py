...
class Ui_frmMainHouse(object):
    def setupUi(self, frmMainHouse):
        ...
        self.lblImagem.setGeometry(QtCore.QRect(3, 110, 1000, 521))
        self.lblImagem.setText(_fromUtf8(""))
        self.lblImagem.setPixmap(QtGui.QPixmap(_fromUtf8("../controle movimentos portaria 2.png")))
        ...
        self.descaSubMenuTECA = QtGui.QAction(frmMainHouse)
        self.descaSubMenuTECA.setObjectName(_fromUtf8("descaSubMenuTECA"))
        
        self.descaSubMenuCavaco = QtGui.QAction(frmMainHouse)
        self.descaSubMenuCavaco.setObjectName(_fromUtf8("descaSubMenuCavaco"))
        
        self.carreSubMenuMadeira = QtGui.QAction(frmMainHouse)
        self.carreSubMenuMadeira.setObjectName(_fromUtf8("carreSubMenuMadeira"))
        
        self.carreSubCavacoSerragem = QtGui.QAction(frmMainHouse)
        self.carreSubCavacoSerragem.setObjectName(_fromUtf8("carreSubCavacoSerragem"))
        ...
        self.subMenuDescarregamento.addAction(self.descaSubMenuTECA)
        self.subMenuDescarregamento.addAction(self.descaSubMenuCavaco)
        self.subMenuCarregamentos.addAction(self.carreSubMenuMadeira)
        self.subMenuCarregamentos.addAction(self.carreSubCavacoSerragem)
    ...
    def retranslateUi(self, frmMainHouse):
        ...
        self.descaSubMenuTECA.setText(_translate("frmMainHouse", "TECA", None))
        self.descaSubMenuCavaco.setText(_translate("frmMainHouse", "Cavaco / Pó Serragem", None))
        self.carreSubMenuMadeira.setText(_translate("frmMainHouse", "Madeira", None))
        self.carreSubCavacoSerragem.setText(_translate("frmMainHouse", "Cavaco /Pó Serragem", None))
        self.veicEmpSubMenuEntrada.setText(_translate("frmMainHouse", "Entrada", None))
        self.veicEmpSaida.setText(_translate("frmMainHouse", "Saida", None))
        self.veiTerSubMenuEntrada.setText(_translate("frmMainHouse", "Entrada", None))
        self.veicTerSubMenuSaida.setText(_translate("frmMainHouse", "Saida", None))
        self.camiEmpSubMenuEntrada.setText(_translate("frmMainHouse", "Entrada", None))
        self.camiEmpSubMenuSaida.setText(_translate("frmMainHouse", "Saida", None))
        ...
        self.entSadMaquiSubMenuSaida.setText(_translate("frmMainHouse", "Saida", None))
