...
class Ui_frmCadastroEntradaFuncionario(object):
    ...
    def retranslateUi(self, frmCadastroEntradaFuncionario):
        ...
        self.btnCadSetoresSalvar.setWhatsThis(_translate("frmCadastroEntradaFuncionario", "Botão para salvar um novo registro", None))
        self.btnCadSetoresSalvar.setText(_translate("frmCadastroEntradaFuncionario", "Salvar", None))
        self.btnCadSetoresCancelar.setWhatsThis(_translate("frmCadastroEntradaFuncionario", "Botão de cancelar a operação iniciada", None))
        self.btnCadSetoresCancelar.setText(_translate("frmCadastroEntradaFuncionario", "Cancelar", None))
        self.btnCadSetoresNovo.setWhatsThis(_translate("frmCadastroEntradaFuncionario", "Botão de Criação de um novo registro", None))
        self.btnCadSetoresNovo.setText(_translate("frmCadastroEntradaFuncionario", "Novo", None))
