...
class Ui_frmCadastroEmpresa(object):
    def setupUi(self, frmCadastroEmpresa):
        ...
        self.txtFantasia.setGeometry(QtCore.QRect(8, 128, 844, 25))
        ...
        self.txtCnae = QtGui.QLineEdit(self.geral)
        self.txtCnae.setGeometry(QtCore.QRect(10, 100, 171, 25))
        self.txtCnae.setInputMethodHints(QtCore.Qt.ImhPreferNumbers|QtCore.Qt.ImhPreferUppercase|QtCore.Qt.ImhUppercaseOnly)
        self.txtCnae.setObjectName(_fromUtf8("txtCnae"))

        self.lblCnae = QtGui.QLabel(self.geral)
        self.lblCnae.setGeometry(QtCore.QRect(10, 80, 41, 19))
        self.lblCnae.setObjectName(_fromUtf8("lblCnae"))

        self.txtCnaeDescricao = QtGui.QLineEdit(self.geral)
        self.txtCnaeDescricao.setEnabled(False)
        self.txtCnaeDescricao.setGeometry(QtCore.QRect(190, 100, 661, 25))
        self.txtCnaeDescricao.setInputMethodHints(QtCore.Qt.ImhPreferNumbers|QtCore.Qt.ImhPreferUppercase|QtCore.Qt.ImhUppercaseOnly)
        self.txtCnaeDescricao.setObjectName(_fromUtf8("txtCnaeDescricao"))

        self.lblDescricaoCnae = QtGui.QLabel(self.geral)
        self.lblDescricaoCnae.setGeometry(QtCore.QRect(190, 80, 201, 19))
        self.lblDescricaoCnae.setObjectName(_fromUtf8("lblDescricaoCnae"))

        self.btnPesquisarCnae = QtGui.QPushButton(self.geral)
        self.btnPesquisarCnae.setGeometry(QtCore.QRect(171, 114, 16, 16))
        self.btnPesquisarCnae.setFocusPolicy(QtCore.Qt.NoFocus)
        self.btnPesquisarCnae.setText(_fromUtf8(""))
        self.btnPesquisarCnae.setIcon(icon)
        self.btnPesquisarCnae.setFlat(True)
        self.btnPesquisarCnae.setObjectName(_fromUtf8("btnPesquisarCnae"))
        ...
        self.lblCnae.setBuddy(self.txtInscricaoMunicipal)
        self.lblDescricaoCnae.setBuddy(self.txtInscricaoMunicipal)
    ...
    def retranslateUi(self, frmCadastroEmpresa):
        ...
        self.txtCnae.setToolTip(_translate("frmCadastroEmpresa", "Inscrição Municipal", None))
        self.txtCnae.setWhatsThis(_translate("frmCadastroEmpresa", "<html><head/><body><p>Campo do codigo da cnae da empresa</p></body></html>", None))
        self.txtCnae.setInputMask(_translate("frmCadastroEmpresa", "0000-0/00; ", None))
        self.lblCnae.setText(_translate("frmCadastroEmpresa", "CNAE", None))
        self.txtCnaeDescricao.setToolTip(_translate("frmCadastroEmpresa", "Inscrição Municipal", None))
        self.txtCnaeDescricao.setWhatsThis(_translate("frmCadastroEmpresa", "<html><head/><body><p>Campo da descricao da atividade economica da empresa</p></body></html>", None))
        self.lblDescricaoCnae.setText(_translate("frmCadastroEmpresa", "Descrição Atividade Economica", None))
        self.btnPesquisarCnae.setWhatsThis(_translate("frmCadastroEmpresa", "Botão para pesquisar dados de empresa", None))
