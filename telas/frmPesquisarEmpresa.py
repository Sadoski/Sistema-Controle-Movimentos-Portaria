...
class Ui_frmConsultarEmpresa(object):
    def setupUi(self, frmConsultarEmpresa):
        ...
        self.lblPesquisar = QtGui.QLabel(frmConsultarEmpresa)
    ...
    def retranslateUi(self, frmConsultarEmpresa):
        ...
        self.radBtnCodigo.setToolTip(_translate("frmConsultarEmpresa", "Fantasia", None))
        ...
        self.txtPesquisar.setWhatsThis(_translate("frmConsultarEmpresa", "Campo de inserir os dados para pesquisar", None))
        self.lblPesquisar.setText(_translate("frmConsultarEmpresa", "Pesquisar", None))
        ...
        item.setText(_translate("frmConsultarEmpresa", "Ins. Estdual", None))
