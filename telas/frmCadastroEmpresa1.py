...
class Ui_frmCadastroEmpresa(object):
    def setupUi(self, frmCadastroEmpresa):
        ...
        frmCadastroEmpresa.resize(889, 461)
        font = QtGui.QFont()
        ...
        self.grubTextos.setGeometry(QtCore.QRect(4, 9, 881, 361))
        ...
        self.txtTelefone.setGeometry(QtCore.QRect(222, 303, 191, 25))
        ...
        self.lblTelefoene.setGeometry(QtCore.QRect(222, 283, 61, 19))
        ...
        frmCadastroEmpresa.setTabOrder(self.txtEstados, self.txtTelefone)
        frmCadastroEmpresa.setTabOrder(self.txtTelefone, self.btnNovo)
