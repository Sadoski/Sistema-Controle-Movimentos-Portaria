...
class Ui_frmEntradaVeiculosCarregamento(object):
    ...
    def retranslateUi(self, frmEntradaVeiculosCarregamento):
        ...
        self.btnDeletar.setWhatsThis(_translate("frmEntradaVeiculosCarregamento", "Botão de cancelar a operação iniciada", None))
        self.btnDeletar.setText(_translate("frmEntradaVeiculosCarregamento", "Deletar", None))
        ...
        self.btnEditar.setWhatsThis(_translate("frmEntradaVeiculosCarregamento", "Botão para salvar um novo registro", None))
        self.btnEditar.setText(_translate("frmEntradaVeiculosCarregamento", "Editar", None))
