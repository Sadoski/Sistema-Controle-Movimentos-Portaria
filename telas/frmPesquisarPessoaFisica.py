...
class Ui_frmPesquisarPessoaFisica(object):
    def setupUi(self, frmPesquisarPessoaFisica):
        ...
        self.tabPesquisar.setColumnCount(18)
    ...
    def retranslateUi(self, frmPesquisarPessoaFisica):
        ...
        item.setText(_translate("frmPesquisarPessoaFisica", "Sobrenome", None))
        ...
        item.setText(_translate("frmPesquisarPessoaFisica", "UF", None))
