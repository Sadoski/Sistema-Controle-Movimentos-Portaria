...
# Form implementation generated from reading ui file 'frmCadFornecedor2.ui'
#
...
class Ui_frmCadastroFornecedor(object):
    def setupUi(self, frmCadastroFornecedor):
        ...
        frmCadastroFornecedor.resize(890, 544)
        frmCadastroFornecedor.setMinimumSize(QtCore.QSize(890, 544))
        frmCadastroFornecedor.setMaximumSize(QtCore.QSize(890, 544))
        font = QtGui.QFont()
        ...
        frmCadastroFornecedor.setSizeGripEnabled(True)
        frmCadastroFornecedor.setModal(True)

        self.grbDadosPessoaFisicaJuridica = QtGui.QGroupBox(frmCadastroFornecedor)
        ...
        self.lblNomeFantasia.setGeometry(QtCore.QRect(8, 108, 151, 19))
        ...
        self.tabWiAdicionais = QtGui.QTabWidget(frmCadastroFornecedor)
        ...
        self.grbTipoPessoa = QtGui.QGroupBox(frmCadastroFornecedor)
        ...
        frmCadastroFornecedor.setTabOrder(self.txtCodigo, self.txtCnpj)
        frmCadastroFornecedor.setTabOrder(self.txtCnpj, self.txtInscricaoEstadua)
        frmCadastroFornecedor.setTabOrder(self.txtInscricaoEstadua, self.txtRazaoSocial)
        frmCadastroFornecedor.setTabOrder(self.txtRazaoSocial, self.txtFantasia)
        frmCadastroFornecedor.setTabOrder(self.txtFantasia, self.tabWiAdicionais)
        frmCadastroFornecedor.setTabOrder(self.tabWiAdicionais, self.radBtnAtivo)
        frmCadastroFornecedor.setTabOrder(self.radBtnAtivo, self.radBtnDesativo)
        frmCadastroFornecedor.setTabOrder(self.radBtnDesativo, self.txtContatoTelefone)
        frmCadastroFornecedor.setTabOrder(self.txtContatoTelefone, self.txtNumeroTelefone)
        frmCadastroFornecedor.setTabOrder(self.txtNumeroTelefone, self.txtContatoEmail)
        frmCadastroFornecedor.setTabOrder(self.txtContatoEmail, self.txtEnderecoEmail)
    ...
    def retranslateUi(self, frmCadastroFornecedor):
        ...
        self.grbDadosPessoaFisicaJuridica.setWhatsThis(_translate("frmCadastroFornecedor", "Grupo de Dados para cadastro e edição de empresas", None))
        self.grbDadosPessoaFisicaJuridica.setTitle(_translate("frmCadastroFornecedor", "Dados Pessoa Fisica / Juridica", None))
        self.txtCnpj.setToolTip(_translate("frmCadastroFornecedor", "CNPJ ou CPF", None))
        self.txtCnpj.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Campo do numero do CNPJ ou CPF do fornecedor</p></body></html>", None))
        self.lblRazaoSocial.setText(_translate("frmCadastroFornecedor", "Razão Social / Nome", None))
        self.lblCnpj.setText(_translate("frmCadastroFornecedor", "CNPJ / CPF", None))
        self.txtRazaoSocial.setToolTip(_translate("frmCadastroFornecedor", "Razão Social ou Nome", None))
        self.txtRazaoSocial.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Campo do nome da razão social ou nome do fornecedor</p></body></html>", None))
        self.lblNomeFantasia.setText(_translate("frmCadastroFornecedor", "Fantasia / Sobrenome", None))
        self.txtInscricaoEstadua.setToolTip(_translate("frmCadastroFornecedor", "Inscrição Estadual ou RG", None))
        self.txtInscricaoEstadua.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Campo do numero do inscrição estadual ou RG do fornecedor</p></body></html>", None))
        self.txtFantasia.setToolTip(_translate("frmCadastroFornecedor", "<html><head/><body><p>Nome Fantasia ou Sobrenome</p></body></html>", None))
        self.txtFantasia.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Campo do nome fantasia ou sobrenome do fornecedor</p></body></html>", None))
        self.lblInscricaoEstadual.setText(_translate("frmCadastroFornecedor", "Incr. Esta. / RG", None))
        self.lblCodigo.setText(_translate("frmCadastroFornecedor", "Codigo", None))
        self.txtCodigo.setToolTip(_translate("frmCadastroFornecedor", "Codigo", None))
        self.txtCodigo.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Campo do numero de identificação do fornecedor</p></body></html>", None))
        self.btnPesquisarEmpresa.setWhatsThis(_translate("frmCadastroFornecedor", "Botão para pesquisar dados de fornecedor", None))
        self.tabWiAdicionais.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Botão adicionar um novo cargo a lista</p></body></html>", None))
        self.grbAtivo.setTitle(_translate("frmCadastroFornecedor", "Situação", None))
        self.radBtnAtivo.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Item de seleção para fornecedor ativa e operante</p></body></html>", None))
        self.radBtnAtivo.setText(_translate("frmCadastroFornecedor", "Ativo", None))
        self.radBtnDesativo.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Item de seleção para fornecedor desativado e inoperante</p></body></html>", None))
        self.radBtnDesativo.setText(_translate("frmCadastroFornecedor", "Desativo", None))
        self.label.setText(_translate("frmCadastroFornecedor", "Observação", None))
        self.txtObservacao.setToolTip(_translate("frmCadastroFornecedor", "Observação", None))
        self.txtObservacao.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Campo de texto de observação sobre o fornecedor</p></body></html>", None))
        self.tabWiAdicionais.setTabText(self.tabWiAdicionais.indexOf(self.geral), _translate("frmCadastroFornecedor", "Geral", None))
        self.tabContatoTelefone.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Tabela de informações de contato de telefone</p></body></html>", None))
        item = self.tabContatoTelefone.horizontalHeaderItem(0)
        item.setText(_translate("frmCadastroFornecedor", "Contato", None))
        item = self.tabContatoTelefone.horizontalHeaderItem(1)
        item.setText(_translate("frmCadastroFornecedor", "Telefone", None))
        self.btnRemoverTelefone.setToolTip(_translate("frmCadastroFornecedor", "Remover", None))
        self.btnRemoverTelefone.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Botão remover um contato  de telefone a lista</p></body></html>", None))
        self.btnAddEmail.setToolTip(_translate("frmCadastroFornecedor", "Adicionar", None))
        self.btnAddEmail.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Botão adicionar um contato de e-mail a lista</p></body></html>", None))
        self.lblContatoTelefone.setText(_translate("frmCadastroFornecedor", "Contato", None))
        self.lblContatoEmail.setText(_translate("frmCadastroFornecedor", "Contato", None))
        self.btnAddTelefone.setToolTip(_translate("frmCadastroFornecedor", "Adicionar", None))
        self.btnAddTelefone.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Botão adicionar um contato de telefone a lista</p></body></html>", None))
        self.txtNumeroTelefone.setToolTip(_translate("frmCadastroFornecedor", "Telefone", None))
        self.txtNumeroTelefone.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Campo do numero de telefone do contato</p></body></html>", None))
        self.txtEnderecoEmail.setToolTip(_translate("frmCadastroFornecedor", "E-mail", None))
        self.txtEnderecoEmail.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Campo do endereço de e-mail do contato</p></body></html>", None))
        self.txtContatoEmail.setToolTip(_translate("frmCadastroFornecedor", "Contato", None))
        self.txtContatoEmail.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Campo do nome do contato</p></body></html>", None))
        self.tabContatoEmail.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Tabela de informações de endereço de e-mail</p></body></html>", None))
        item = self.tabContatoEmail.horizontalHeaderItem(0)
        item.setText(_translate("frmCadastroFornecedor", "Contato", None))
        item = self.tabContatoEmail.horizontalHeaderItem(1)
        item.setText(_translate("frmCadastroFornecedor", "E-mail", None))
        self.txtContatoTelefone.setToolTip(_translate("frmCadastroFornecedor", "Contato", None))
        self.txtContatoTelefone.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Campo do nome do contato</p></body></html>", None))
        self.lblEmail.setText(_translate("frmCadastroFornecedor", "E-mail", None))
        self.btnRemoverEmail.setToolTip(_translate("frmCadastroFornecedor", "Remover", None))
        self.btnRemoverEmail.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Botão remover um contato de e-mail da lista</p></body></html>", None))
        self.lblTelefone.setText(_translate("frmCadastroFornecedor", "Telefone", None))
        self.tabWiAdicionais.setTabText(self.tabWiAdicionais.indexOf(self.contatos), _translate("frmCadastroFornecedor", "Contato", None))
        self.btnNovo.setToolTip(_translate("frmCadastroFornecedor", "Novo", None))
        self.btnNovo.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Botão para cadastrar uma novo registro da pessoa jurídica</p></body></html>", None))
        self.btnNovo.setText(_translate("frmCadastroFornecedor", "Novo", None))
        self.btnSalvar.setToolTip(_translate("frmCadastroFornecedor", "Salvar", None))
        self.btnSalvar.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Botão para salvar um novo registro da pessoa jurídica</p></body></html>", None))
        self.btnSalvar.setText(_translate("frmCadastroFornecedor", "Salvar", None))
        self.btnCancelar.setToolTip(_translate("frmCadastroFornecedor", "Cancelar", None))
        self.btnCancelar.setWhatsThis(_translate("frmCadastroFornecedor", "Botão para cancelar a operação ", None))
        self.btnCancelar.setText(_translate("frmCadastroFornecedor", "Cancelar", None))
        self.btnDeletar.setToolTip(_translate("frmCadastroFornecedor", "Deletar", None))
        self.btnDeletar.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Botão de deletar o registro da pessoa jurídica</p></body></html>", None))
        self.btnDeletar.setText(_translate("frmCadastroFornecedor", "Deletar", None))
        self.btnEditar.setToolTip(_translate("frmCadastroFornecedor", "Editar", None))
        self.btnEditar.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Botão para salvar o registo editado da pessoa jurídica</p></body></html>", None))
        self.btnEditar.setText(_translate("frmCadastroFornecedor", "Editar", None))
        self.lblPesquisar.setText(_translate("frmCadastroFornecedor", "[F12] Pesquisar", None))
        self.grbTipoPessoa.setTitle(_translate("frmCadastroFornecedor", "Tipo de Pessoa", None))
        self.radBtnPessoaFisica.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Item de seleção para cadastro de fornecedor Pessoa Fisica</p></body></html>", None))
        self.radBtnPessoaFisica.setText(_translate("frmCadastroFornecedor", "Pessoa Fisica", None))
        self.radBtnPessoaJuridica.setWhatsThis(_translate("frmCadastroFornecedor", "<html><head/><body><p>Item de seleção para cadastro de fornecedor Pessoa Juridica</p></body></html>", None))
        self.radBtnPessoaJuridica.setText(_translate("frmCadastroFornecedor", "Pessoa Juridica", None))
