...
class Ui_frmMainHouse(object):
    def setupUi(self, frmMainHouse):
        ...
        self.menuDescaEntrada = QtGui.QAction(self.subMenuDescarregamento)
        self.menuDescaEntrada.setObjectName(_fromUtf8("menuDescaEntrada"))

        self.menuDescaSaida = QtGui.QAction(self.subMenuDescarregamento)
        self.menuDescaSaida.setObjectName(_fromUtf8("menuDescaCavacoPoSerragem"))
        ...
        self.menuCarregEntrada = QtGui.QAction(self.subMenuCarregamentos)
        self.menuCarregEntrada.setObjectName(_fromUtf8("menuCarregEntrada"))

        self.menuCarregSaida = QtGui.QAction(self.subMenuCarregamentos)
        ...
        self.submMenuEntradaSaidaVeiculosLeves.addAction(self.veiTerSubMenuEntrada)
        self.submMenuEntradaSaidaVeiculosLeves.addAction(self.veicTerSubMenuSaida)
    ...
    def retranslateUi(self, frmMainHouse):
        ...
        self.menuDescaSaida.setText(_translate("frmMainHouse", "Saída", None))
        ...
        self.menuCarregSaida.setText(_translate("frmMainHouse", "Saída", None))
