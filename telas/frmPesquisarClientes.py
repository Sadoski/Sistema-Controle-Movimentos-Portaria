...
class Ui_frmPesquisarCliente(object):
    ...
    def retranslateUi(self, frmPesquisarCliente):
        ...
        item.setText(_translate("frmPesquisarPessoaFisicaJuridica", "Tipo Pessoa", None))
        ...
        item.setText(_translate("frmPesquisarPessoaFisicaJuridica", "Fantasia / Sobrenome", None))
        ...
        item.setText(_translate("frmPesquisarPessoaFisicaJuridica", "Expeditor", None))
        item = self.tabPesquisar.horizontalHeaderItem(7)
        item.setText(_translate("frmPesquisarPessoaFisicaJuridica", "UF", None))
        item = self.tabPesquisar.horizontalHeaderItem(8)
        item.setText(_translate("frmPesquisarPessoaFisicaJuridica", "Aniversario", None))
        ...
        item.setText(_translate("frmPesquisarPessoaFisicaJuridica", "Site", None))
        item = self.tabPesquisar.horizontalHeaderItem(17)
        item.setText(_translate("frmPesquisarPessoaFisicaJuridica", "Observação", None))
        item = self.tabPesquisar.horizontalHeaderItem(18)
        item.setText(_translate("frmPesquisarPessoaFisicaJuridica", "Situação", None))
