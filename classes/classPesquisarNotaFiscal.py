...
class PesquisarNotaFiscal(QtGui.QDialog):
    ...
    def pesquisar(self):
        if self.ui.radBtnNumNotaFiscal.isChecked():
            ...
            __pesDao = PesquisarNotaFiscalRomaneioDao()
            __retorno = __pesDao.pesquisarNumeroRomaneio(__insEmitente)
        ...
        elif self.ui.radBtnDataPeriodose.isChecked():
            __dataIni = self.ui.txtDataInicial.text()
            __dataFim = self.ui.txtDataFinal.text()
            __pesDao = PesquisarNotaFiscalRomaneioDao()
