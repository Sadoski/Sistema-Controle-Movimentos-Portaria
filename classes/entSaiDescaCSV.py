...
class EntSaiDescaCSV():
    ...
    def gerarCsv(self):
        ...
        for dad in self.lista:
            ...
            listaInterna.append(entSaiDao.pesquisarMotoristaDescaRel(dad['Motorista']))
            listaInterna.append(dad['Marca'])
            listaInterna.append(dad['Modelo'])
            listaInterna.append(dad['Placa'])
            listaInterna.append(entSaiDao.pesquisarFornecedorDescaRel(dad['Cliente']))
        ...
        if self.dir:
            with open(self.dir, 'w') as csvfile:
                ...
                spamwriter.writerow(['Relatório Entrada e Saida Descarregamento'])
                spamwriter.writerow(['Codigo', 'Data Entrada', 'Hora Entrada', 'Data Saida', 'Hora Saida', 'Nº NF', 'Produto', 'Motorista', 'Marca', 'Modelo', 'Placa', 'Fornecedor'])
