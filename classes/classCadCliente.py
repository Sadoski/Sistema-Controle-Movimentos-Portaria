...
class CadastroClientes(QtGui.QDialog):
    ...
    def simDeletar(self):
            ...
            a = motoDao.deletarCliente(str(codigo))
            if self.contatoAdd != []:
    ...
    def deletarTelefoneFrom(self):
        ...
        for lista in self.contatoAdd :
            ...
            emp.deletarTelefone(idTelefone, str(self.idCliente))
            pesquisa = emp.pesquisaTelefoneCliente(idTelefone, str(self.idCliente))
            if pesquisa == "":
                emp.deletarContatoTelefone(idTelefone)
    ...
    def deletarEmailFrom(self):
        ...
        for lista in self.emailAdd:
            ...
            emp.deletarEmail(idEmail, str(self.idCliente))
            pesquisa = emp.pesquisaEmailCliente(idEmail, str(self.idCliente))
            if pesquisa == "":
                emp.deletarContatoEmail(idEmail)
